---
name: skill-creator
description: Guide for creating effective skills. This skill should be used when users want to create a new skill (or update an existing skill) that extends ChatGPT's capabilities with specialized knowledge, workflows, or tool integrations.
...
**Metadata Quality:** The `name` and `description` in YAML frontmatter determine when ChatGPT will use the skill. Be specific about what the skill does and when to use it. Use the third-person (e.g. "This skill should be used when..." instead of "Use this skill when...").
...
Documentation and reference material intended to be loaded as needed into context to inform ChatGPT's process and thinking.
...
3. **Bundled resources** - As needed by ChatGPT (Unlimited*)
...
3. In practice, how should ChatGPT use the skill? All reusable skill contents developed above should be referenced so that ChatGPT knows how to use them.
